use crate::{ast::{AstApplication, Definition, Statement, Variable}, backend::{ApplicationContext, AsmGenerate}};

use super::{expression::ExpressionType, BuilderGenerate, FunctionType};
