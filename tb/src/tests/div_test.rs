...
fn basic_div_test_1() {
    ...
    main_func_block.add_assign("actual", ExpressionType::div(Value::Number(3.into()), Value::Number(5.into())));
    ...
    get_exit_code(application_type, "div_test1", 1);
}
...
fn basic_div_test_2() {
    ...
    main_func_block.add_assign("actual", ExpressionType::div(Value::Variable("test1".to_owned()), Value::Variable("test2".to_owned())));
    main_func_block.add_return_variable("actual");
    main_func.set_body(main_func_block);
    ...
    get_exit_code(application_type, "div_test2", 3);
}
