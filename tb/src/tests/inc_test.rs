...
fn basic_inc_test_1() {
    ...
    main_func_block.add_assign("actual", ExpressionType::inc("actual".to_owned()));
    ...
    get_exit_code(application_type, "inc_test1", 11);
}
...
fn basic_inc_test_2() {
    ...
    get_exit_code(application_type, "inc_test2", -9);
}
