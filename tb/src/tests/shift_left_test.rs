...
fn basic_bitwise_and_test_1() {
    ...
    main_func_block.add_assign("actual", ExpressionType::shift_left(Value::Number(101), Value::Number(1)));
    ...
    get_exit_code(application_type, "shift_left_test1", 1);
}
...
fn basic_shift_left_test_2() {
    ...
    get_exit_code(application_type, "shift_left_test2", 2);
}